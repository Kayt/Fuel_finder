...
return (function response(chat) {
    ...
    // throw new Error('========================= Stop execution, Avoided duplicates ====================================');
    return goAgain(response, 3);
    ...
    if (ignoreLastMsg[title] && (ignoreLastMsg[title]) == lastMsg) {
        console.log("Got nothing to send now , Avoiding duplicate");
        throw new Error('========================= Avoided duplicates ====================================');
    ...
    if (!sendText) {
        ...
        console.log("new message ignored");
        throw new Error('========================= new message ignored ====================================');
    }
    ...
    if (!processLastMsgOnChat){
        console.log('============================= Getting  Ready to send message ======================== ')
